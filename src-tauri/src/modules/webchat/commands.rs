...
(function(){
  // Thin dark scrollbar override — matches the host app shell. Beats site
  // CSS via !important; appended again on DOMContentLoaded because some
  // hosts wipe <head> styles during hydration.
