...
use modules::separator::{
    ...
    separator_extract_midi, separator_list_jobs, separator_remove_job, separator_run,
    separator_scan_disk, separator_status, SeparatorState,
};
...
pub fn run() {
    ...
    builder
        .invoke_handler(tauri::generate_handler![
            ...
            modules::neuralnote::commands::neuralnote_status,
            modules::neuralnote::commands::neuralnote_install,
            modules::neuralnote::commands::neuralnote_open,
