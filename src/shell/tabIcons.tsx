...
/// Per-tab visual identity. Shared between the popup tab bar and the tray
/// context menu (see `trayMenu.ts`) so adding or tweaking an icon is a
/// one-line edit here rather than touching each surface independently.
