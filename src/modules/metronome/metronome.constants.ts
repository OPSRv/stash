...
export const SOUND_PRESETS: readonly SoundPreset[] = [
  { id: 'click', label: 'Click', baseHz: 1000, accentHz: 1500, type: 'sine', decay: 0.04 },
  { id: 'wood', label: 'Wood', baseHz: 600, accentHz: 900, type: 'triangle', decay: 0.06 },
  { id: 'beep', label: 'Beep', baseHz: 800, accentHz: 1200, type: 'square', decay: 0.05 },
];
