...
`⌘⇧V` — і перед тобою компактний попап 920×520, у якому під рукою **13 модулів**: буфер обміну, нотатки, перекладач, AI-чат, Pomodoro, метроном, термінал, завантажувач відео, музика, вбудовані web-чати, Telegram-бот, системні утиліти й налаштування.
